...
public class DisplayEngineController {
    ...
    static {
        try {
            ...
            Log.e("DisplayEngineController", "DisplayEngineService not available");
    ...
    public static boolean isSupported() {
        if (sDisplayEngineService == null) {
            Log.e("DisplayEngineController", "DisplayEngineService is null");
            return false;
        }
      
        if (!sDisplayEngineService.isColorModeSupported()) {
            Log.e("DisplayEngineController", "ColorMode is not supported");
            return false;
        }
      
        if (!FileUtils.isFileWritable(DEFAULT_PATH) &&
            !FileUtils.isFileReadable(DEFAULT_PATH)) {
            Log.e("DisplayEngineController", "Default path isn't readable and/or writable");
            return false;
        }
        return true;
    }
